...
public class lotteryGame {
   ...
   public static int[] userNumbers(Scanner console) throws Exception {
      ...
      if (option.equals("1")) { //If user chooses option 1, they keep their saved numbers
         ...
         System.out.println("Only print numbers between 1-3");
   ...
   public static void saveNumbers(int[] numbers) throws Exception {
      PrintStream out = new PrintStream(new File("lotto.dat"));
      for (int i = 0; i < 6; i++) {
         out.print(numbers[i] + " ");
      }
   ...
   Scanner console = new Scanner(System.in);
      int[] user = userNumbers(console);
      int[] lottoNumber = drawNumbers(true);
      doCompare(user, lottoNumber);
      playAgain(console);
